...
| 台灣使用者熟悉度 | 中高，僅次於綠界，國內信用卡付款體驗順暢 |
| 串接複雜度 | 中，API 文件完整，有 sandbox 測試環境 |
| 手續費與撥款 | 信用卡約 2.5%~2.9%；超商/ATM 約 12~18 元；撥款週期約 T+2 ~ T+7 |
| 適合 49 元小額付款 | **適中** — 信用卡手續費約 1.2~1.5 元，無最低手續費門檻，49 元級別仍可行 |
| 發票 / 稅務 | 提供電子發票 API，可串接 |
| 對目前 MVP 適合度 | **高** — 個人可申請、信用卡手續費無最低門檻最適合 49 元、支援廣泛 |
...
| 適合 49 元小額付款 | **略偏重** — 信用卡尚可，但部分方案有最低手續費門檻（如每筆最低 3~5 元），對 49 元影響較大 |
| 發票 / 稅務 | 綠界提供電子發票加值服務（需額外申請與費用），電商工具較完整 |
| 對目前 MVP 適合度 | **中高** — 成熟度高、電商生態完整，但最低手續費門檻對 49 元可能吃掉較多利潤 |

### 5c. Line Pay（後續加值付款方式）
...
| 對目前 MVP 適合度 | **低（第一版）** — 更適合作為第二期提升付款轉換率的加值付款方式，不建議作為唯一主金流 |

### 5d. 結論

AI創業紅綠燈第一版為 **49 元小額一次性付款**，金流選擇的核心考量是「信用卡手續費對 49 元的適用性」與「個人開發者的申請門檻」。

| 順位 | 服務 | 理由 |
|------|------|------|
| **第一候選** | 藍新 NewebPay | 信用卡手續費無最低門檻，對 49 元最友善；個人可申請；支援廣泛 |
| **備選** | 綠界 ECPay | 成熟度高、電商工具完整、電子發票周邊較齊全；但最低手續費門檻對 49 元可能吃掉較多 |
| **後續加值** | Line Pay | 使用者熟悉度高，但申請門檻較高；適合第二階段作為提升轉換率的輔助付款方式 |

**建議第一版真金流先以「一次性信用卡付款」為主**，不要一開始同時接太多付款方式。讓金流流程保持簡單：

1. 使用者點擊付款 → 導向藍新信用卡付款頁面
2. 付款成功 → webhook 通知後端 → 使用者回到網站填寫後三題
3. 等到第一期上線穩定後，再評估是否需要加入 Line Pay 或超商付款
